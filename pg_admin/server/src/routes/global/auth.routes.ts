...
import { createUserHandler, getAllUsersHandler, getInactiveUsersHandler, getUserByIdHandler, loginUserHandler, registerUserHandler, updateProfileHandler, updateUserHandler } from '../../controllers/global/auth.controller';
