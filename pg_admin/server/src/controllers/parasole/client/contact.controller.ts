...
import { createContactUsForm, getContact, getContactMedia } from "../../../services/parasole/client/contact.service";
...
export const ContactController = {
    getContact: async (req: Request, res: Response): Promise<void> => {
        try {
            ...
            res.status(500).json({
                success: false,
                message: error instanceof Error ? error.message : 'Failed to fetch Contact data'
            });
        }
    },
