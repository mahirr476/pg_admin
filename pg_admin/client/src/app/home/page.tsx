...
//   const pageNumbers = [];
//   for (let i = 1; i <= Math.ceil(filteredSections.length / itemsPerPage); i++) {
//     pageNumbers.push(i);
//   }
...
//     }
//   }, [filteredSections, currentPage,pageNumbers.length]);

//   return (
//     <div className="p-6 max-w-full mx-auto ml-64">
