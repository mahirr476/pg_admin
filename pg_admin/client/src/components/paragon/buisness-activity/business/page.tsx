...
const BusinessPage: React.FC = () => {
  ...
  const handleEdit = (business: Business): void => {
    ...
    // Set image previews if available - simple URL format
    if (business.bannerImage) {
                      ...
                      <TableRow key={business.id}>
                        ...
                        <TableCell>
                          {business.bannerImage ? (
                            <div className="h-20 w-32 rounded-md overflow-hidden bg-gray-100 flex items-center justify-center relative">
                              <Image
                                src={`http://localhost:7000/${business.bannerImage}`}
                                alt={business.title}
                                width={320}
                                height={200}
                                className="h-full w-full object-cover"
                      ...
                      <div className="relative border border-gray-200 rounded-md p-2 bg-gray-50">
                        ...
                        >
                          {bannerPreview ? (
                            <div className="relative w-full h-full">
                              <Image
                                src={bannerPreview.startsWith('http') ? bannerPreview : `http://localhost:7000/${bannerPreview}`}
                                alt="Banner Preview"
                                width={320}
                                height={240}
                                className="w-full h-full object-cover rounded-md"
                      ...
                      <div className="relative border border-gray-200 rounded-md p-2 bg-gray-50">
                        ...
                        >
                          {imagePreview ? (
                            <div className="relative w-full h-full">
                              <Image
                                src={imagePreview.startsWith('http') ? imagePreview : `http://localhost:7000/${imagePreview}`}
                                alt="Image Preview"
                                width={320}
                                height={240}
                                className="w-full h-full object-cover rounded-md"
