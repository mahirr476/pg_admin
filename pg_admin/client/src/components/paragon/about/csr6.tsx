...
const AboutCSR6: React.FC = () => {
  ...
  useEffect(() => {
    const savedMainSection = localStorage.getItem('aboutCSR6MainSection');
  ...
  useEffect(() => {
    if (showData) {
      localStorage.setItem('aboutCSR6MainSection', JSON.stringify(mainSection));
    }
    ...
    <div className="space-y-8">
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogTrigger asChild>
          <Button onClick={handleDialogOpen}>CSR6 Section</Button>
        </DialogTrigger>
