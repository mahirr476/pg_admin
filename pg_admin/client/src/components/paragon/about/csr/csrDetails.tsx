      ...
      {isLoadingDetails ? (
              ...
              {details.map((detail, index) => (
                <tr key={detail.id} className={index % 2 === 0 ? "bg-white dark:bg-slate-800" : "bg-gray-50 dark:bg-slate-700/30"}>
                  ...
                  <td className="px-6 py-4">
                    <div className="text-sm text-gray-500 dark:text-gray-400 line-clamp-2">{detail.description}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg shadow p-8 text-center">
          <p className="text-gray-500 dark:text-gray-400">
            No CSR details found. Click the "Add New CSR Detail" button to add a detail.
          </p>
        </div>
      )}
    </div>
