...
const AboutCSR: React.FC = () => {
  ...
  useEffect(() => {
    const savedMainSection = localStorage.getItem('aboutCSRMainSection');
    const savedSections = localStorage.getItem('aboutCSRSections');
  ...
  useEffect(() => {
    if (showData) {
      localStorage.setItem('aboutCSRMainSection', JSON.stringify(mainSection));
      localStorage.setItem('aboutCSRSections', JSON.stringify(sections));
    }
    ...
    <div className="space-y-8">
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogTrigger asChild>
          <Button onClick={handleDialogOpen}>CSR1 Section</Button>
        </DialogTrigger>
