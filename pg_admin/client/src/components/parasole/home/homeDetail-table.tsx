...
//                         {detail.image ? (
//                           <img
//                             src={`http://localhost:7000/${detail.image.replace(/^\//, '')}`}
//                             alt={detail.title || 'Image'}
//                             className="h-full w-full object-cover"
//                             onError={() => {
//                               // Just use a simple background color with text as fallback
//                               const element = document.getElementById(`img-${detail.id}`);
//                               if (element) {
//                                 element.innerHTML = '<div class="h-full w-full flex items-center justify-center bg-gray-100 text-gray-400 text-xs">No Image</div>';
//                               }
//                             }}
//                             id={`img-${detail.id}`}
//                           />
                          ...
                          <img
                            ...
                            onError={(e) => {
                              ...
                              e.currentTarget.parentElement!.innerHTML =
                                '<div class="h-full w-full flex items-center justify-center bg-gray-100 text-gray-400 text-xs">No Image</div>';
                            }}
                          />
                        ) : (
                          <div className="h-full w-full flex items-center justify-center bg-gray-100 text-gray-400 text-xs">
