...
//           <div>
//             <h1 className="text-3xl font-bold text-gray-900">Operation Management</h1>
//             <p className="mt-1 text-sm text-gray-500">
//               Manage your operation items and their display settings
//             </p>
//           </div>
//           <button
...
//             <h2 className="text-lg font-medium text-gray-900">Operation Items</h2>
//           </div>
...
//                         <span className="text-gray-500">Loading operation items...</span>
//                       </div>
//                     </td>
//                   </tr>
...
//                         <p className="mt-2 text-sm">No operation items available</p>
//                         <button
//                           onClick={handleAddNew}
...
//                   </tr>
//                 ) : (
//                   operationData.map((item: OperationItem) => (
...
//                     </span>
//                   ) : (
//                     selectedItem ? "Update Operation" : "Create Operation"
//                   )}
//                 </button>
//               </div>
//             </form>
...
const OperationPage: React.FC = () => {
  ...
  const getSortedItems = () => {
    ...
    return [...operationData].sort((a, b) => {
      let aValue: any = a[sortBy as keyof OperationItem];
      let bValue: any = b[sortBy as keyof OperationItem];
        ...
        <div className="bg-white shadow-xl rounded-xl overflow-hidden border border-gray-200 transition-all duration-300 hover:shadow-2xl">
          <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50 flex justify-between items-center">
            ...
            <div className="text-sm text-gray-500">
              {operationData.length} item{operationData.length !== 1 ? 's' : ''}
            </div>
          </div>
                  ...
                  <tr>
                    <td colSpan={7} className="px-6 py-16 text-center text-gray-500">
                      <div className="flex flex-col items-center justify-center space-y-3 opacity-0 animate-fade-in">
                        ...
                        <p className="text-sm font-medium">Loading operation items...</p>
                      </div>
                    </td>
                  </tr>
                ) : operationData.length === 0 ? (
                  <tr>
                    <td colSpan={7} className="px-6 py-16 text-center text-gray-500">
                      <div className="flex flex-col items-center justify-center space-y-3 opacity-0 animate-fade-in">
                        ...
                        <p className="text-sm font-medium">No operation items found</p>
