...
import { CheckCircle, XCircle, Pencil, Trash2, Plus, Loader2, ClipboardList } from 'lucide-react';
import { useComplianceDetail } from '@/hooks/parasole/compliance/useComplianceDetail';
import { ComplianceDetailItem } from '@/types/parasole/compliance/complianceDetail';
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {isLoading ? (
                  ...
                  data.map((item: ComplianceDetailItem) => (
                    <tr key={item.id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                        {item.index}
                      </td>
