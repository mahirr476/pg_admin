...
// import { CheckCircle, XCircle, Pencil, Trash2, Plus, Image as ImageIcon, Loader2 } from 'lucide-react';
...
//               Manage your compliance documents and requirements
//             </p>
//           </div>
//           <button 
...
//                         <p className="mt-2 text-sm">No compliance items available</p>
//                         <button 
//                           onClick={handleAddNew}
...
//                             <div className="h-16 w-16 rounded-lg flex items-center justify-center bg-gray-100 border border-gray-200 text-gray-500">
...
import { CheckCircle, XCircle, Pencil, Trash2, Plus, Image as ImageIcon, Loader2 } from 'lucide-react';
import { useCompliance } from '@/hooks/parasole/compliance/useCompliance';
import { ComplianceItem } from '@/types/parasole/compliance/compliance';
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {isLoading ? (
                  ...
                  complianceData.map((item: ComplianceItem) => (
                    <tr key={item.id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                        {item.index}
                      </td>
